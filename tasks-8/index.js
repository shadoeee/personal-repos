...
// Create the <div> for user list
const userListDiv = document.createElement("div");
userListDiv.id = "userList";

// Create the <div> for pagination
...
function createPaginationButtons(users) {
...
// Sample data (you can replace it with your provided data)
const sampleData = [
   {
      "id": "1",
      "name": "Lura Senger",
    ...
    // ... (insert the rest of your provided data here)
];



// Initial display
displayUsers(sampleData, 1);
createPaginationButtons(sampleData);
